        ...
        if (current_metric == "C") {
          ...
          tempCelsius.forEach((element) => {
            element.innerHTML = Math.round(
              celsiusToFahrenheit(Number(element.innerHTML))
            );
          });
          ...
          tempFarenheit.forEach((element) => {
            element.innerHTML = Math.round(
              fahrenheitToCelsius(Number(element.innerHTML))
            );
          });
...
// Função utilizada para definir o ano atual no rodapé da página
